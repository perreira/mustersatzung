...
% Add optional parameter to enumerate environment to set format
\usepackage{enumerate}

% Load spelling/hyphenation, set language to german
\usepackage{polyglossia}
\setdefaultlanguage{german}
\setmainlanguage{german}

% Hyperlinks and PDF things
\usepackage[pdfpagelabels=false]{hyperref}
% Nice tables
\usepackage{booktabs}
% be able to reference the last page for "Page X of Y" stlye pagenumbers
\usepackage{lastpage}
...
\ohead[]{}
\ihead[]{}
\chead[Satzung Verein für Vereinsmaierai mit ai e.V.]{Satzung Verein für Vereinsmaierai mit ai e.V.}
\ofoot[]{}
\ifoot[]{}
